...
Contributions are welcome. `go-ruby-nats/nats` is built to a small set of
...
The library is in [`github.com/go-ruby-nats/nats`](https://github.com/go-ruby-nats/nats).
This documentation site is in [`github.com/go-ruby-nats/docs`](https://github.com/go-ruby-nats/docs).
