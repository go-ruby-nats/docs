...
The public API lives at the module root (`github.com/go-ruby-nats/nats`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `nats`, while the surface follows
...
```go
import "github.com/go-ruby-nats/nats"
```
...
- **[pkg.go.dev/github.com/go-ruby-nats/nats](https://pkg.go.dev/github.com/go-ruby-nats/nats)**

The module's [README](https://github.com/go-ruby-nats/nats#readme) carries worked
